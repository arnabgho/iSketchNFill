...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lr_g', type=float, default=1e-4, help='initial learning rate for adam')
        self.parser.add_argument('--lr_d', type=float, default=4e-4, help='initial learning rate for adam')
        self.parser.add_argument('--use_sn', action='store_true', help='Use Spectral Norm for the Discriminator and the Q Network')
        self.parser.add_argument('--lambda_info', type=float, default=1.0, help='weight for Mutual Information Loss')
        self.parser.add_argument('--lambda_kl', type=float, default=0.01, help='weight for KL Divergence Loss')
