...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--lsgan', action='store_true', help='do *not* use least square GAN, if false, use vanilla GAN')
        self.parser.add_argument('--sketchy_dataset', action='store_true', help='sketchy database used')
        self.parser.add_argument('--autocomplete_dataset_outline', action='store_true', help='autocomplete database used')
        self.parser.add_argument('--autocomplete_dataset_edges', action='store_true', help='autocomplete database used')
        ...
        self.parser.add_argument('--ngres_gate', type=int, default=16, help='# of neurons in the gate block')
        self.parser.add_argument('--ngres', type=int, default=24, help='# of residual blocks')
        self.parser.add_argument('--ngres_up_down', type=int, default=3, help='# of residual blocks')
        self.parser.add_argument('--ndres_down', type=int, default=4, help='# of residual blocks')
        self.parser.add_argument('--ndres_gate', type=int, default=16, help='# of neurons in the gate block')
        self.parser.add_argument('--ndres', type=int, default=24, help='# of residual blocks')
        self.parser.add_argument('--ndf', type=int, default=32, help='# of discrim filters in first conv layer')
        self.parser.add_argument('--ndisc_out_filters', type=int, default=1, help='# of discrim filters in first conv layer')
        ...
        self.parser.add_argument('--n_layers_Q', type=int, default=6, help='only used if which_model_netQ==n_layers')
        ...
        self.parser.add_argument('--dropout_G' , type = float , default=0.0 , help = 'Dropout rate' )
        self.parser.add_argument('--dropout_D' , type = float , default=0.0 , help = 'Dropout rate' )
        self.parser.add_argument('--dropout_gate' , type = float , default=0.0 , help = 'Dropout rate' )
        self.parser.add_argument('--max_dataset_size', type=int, default=float("inf"), help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
        self.parser.add_argument('--resize_or_crop', type=str, default='resize_and_crop', help='scaling and cropping of images at load time [resize_and_crop|crop|scale_width|scale_width_and_crop]')
        self.parser.add_argument('--which_baseline', type=str, default='input', help='which baseline to use')
